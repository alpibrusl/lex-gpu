...
//! - this test runs the same prompts through lex and checks, at every step,
//!   that lex's greedy token matches and its top-5 log-probabilities agree
...
use lex_rt::llama::{Attention, Runner, Weights, log_softmax};
